...
EVENT_05_TEXT = """Im ÖPNV herrscht Maskenpflicht. Die Masken wirken auch nachweislich, allerdings werden Geringverdiener und ALG-Empfäger nicht unterstützt. Gerade diese Bevölkerungsschicht ist besonders auf den ÖPNV angewiesen. Die Pandemie steckt Sozialschwäche Menschen besonders stark, sie erkranken im Vergleich häufiger. Korrelation oder Kausalität? Interessiert die Bundesregierung auf Nachfrage wenig."""
...
EVENT_06_TEXT = """Es stellt sich heraus: Das Virus verbreitet sich tatsächlich in den Klassenräumen. Zwar zeigen die Schüler nur selten Symptome, aber dafür werden die Eltern und Lehrer infiziert. Die Schulen frühzeitig zu öffnen war wohl keine so gute Idee. 
...
EVENT_17_TEXT = """AstraZeneca ist wieder freigegeben. Die genaue Ursache für die Thrombose ist zwar noch nicht klar, aber der Nutzen überwiegt das Risiko. Die Thrombose trifft hauptsächlich bei Menschen über 60 auf, deswegen empfiehlt das RKI und die ständige Impfkommission den Impfstoff nur für diese Altersgruppe. In der Regierung hat sich vermutlich jemand verlesen, denn aus unerklärlichen Gründen wird dieser Impfstoff als erster auch für Menschen ab 18 Jahren komplett freigegeben.
